# Scene Benchmark WebGL wiring

The `scene-benchmark-webgl` fiddle runs native Skia C++ in Wasm and renders through
...
Then run the app and select **Scene Benchmark (WebGL)**:
