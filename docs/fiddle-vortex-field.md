...
This fiddle demonstrates vortex field on a section of curve. There is a similar feature in Adobe Illustrator to apply such local deform on a path with a effect radius.
...
- Increase the tangential for and intensity of the vortex field significantly. A point near the center of the field should be rotated by 3 x 360-degrees, and look like a spiral shaped formed within that circle.
...
Update its description in top level readme. Not about the drawing logic, but how the vortex deform ia calculated on shapes.
